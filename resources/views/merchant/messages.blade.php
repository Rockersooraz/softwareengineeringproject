            ...
            <section class="block">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <nav class="nav flex-column side-nav">
                                ...
                                <a class="nav-link active icon" href="{{ route('showcomment',$merchant->id) }}">
                ...
                <div class="table table-dark">
                    <table class="table">
                                ...
                                <tbody>
                                  <tr>
                                     ...
                                     <td>{{ $c->post->title }} </td>
                                      <td>{{ $c->body }} </td>
                                     <td>
                                        <a href="{{route('post.show',$c->post->id)}}" class="btn btn-info small" >View Post</a>&nbsp;
                                     </form>
                                   </td>
                                  </tr>
                                </tbody>
                        @endforeach
                       @else
                        <tr><td colspan="3">No Review's Yet </td></tr>
                          @endif
                    </table>
                        </div>
                        <!--end col-md-9-->
